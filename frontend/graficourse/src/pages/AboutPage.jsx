    ...
    <PageWrapper>
      ...
      <MainContent>
        <ContentSection>
          ...
          <SectionText>
            GraphiCourse платформасы – бұл қазақстандықтарға компьютер архитектурасы бойынша сапалы білім беру
          ...
          <SectionText>
            ...
            Сондықтан GraphiCourse командасы студенттер мен әуесқойларға арналған тереңдетілген білім беру
      ...
      <Footer>
        <FooterContent>
          ...
          <FooterCopyright>
            © {new Date().getFullYear()} GraphiCourse. Барлық құқықтар қорғалған.
          </FooterCopyright>
        </FooterContent>
      </Footer>
    </PageWrapper>
